...
function module_core.debug(e,AIObjNo,PlayerDist,combattype)
 if ai_bot_state ~= nil then
  if ai_bot_state[e] ~= nil then
   ...
   PromptLocal ( e, "CT=" .. combattype .. " STATE=" .. ai_bot_state[e] .. "(" .. ai_state_debug[1+ai_bot_state[e]] .. ") SUB=" .. ai_bot_substate[e] .. " DIST=" .. PlayerDist .. " AVOID=" .. g_Entity[e]['avoid'] .. " VIS=" .. g_Entity[e]['plrvisible'] .. " COVER=" .. ai_bot_coverindex[e] .. "(" .. AICoverGetIfUsed(ai_bot_coverindex[e]) .. ")" .. " AH=" .. AH )
  else
