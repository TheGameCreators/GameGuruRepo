                     ...
                     _In_ int       nCmdShow)
{
	...
	// Launches real GameGuru binary inside Core (accompanied by DLLS, INIs and other necessary files)
	SetCurrentDirectoryA("Core");
	ShellExecuteA(NULL, "open", "Guru-MapEditor.exe", NULL, NULL, SW_SHOW);
