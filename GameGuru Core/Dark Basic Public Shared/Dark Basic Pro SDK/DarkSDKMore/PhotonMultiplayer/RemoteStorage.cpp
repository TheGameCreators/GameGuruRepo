...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CRemoteStorage::CRemoteStorage( ) : m_pRemoteStorageSync(NULL)
{
...
void CRemoteStorage::CheckState()
{
	...
	case k_ERemoteStorageStateSyncToServer:
		...
		m_eState = k_ERemoteStorageStateIdle;
		Client()->SetGameState( k_EClientGameMenu );
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CRemoteStorageScreen::CRemoteStorageScreen( )
{
	m_rgchGreeting[0] = 0;
...
void CRemoteStorageScreen::Render()
{
	...
	RECT rect;
	{
		...
		m_pGameEngine->BDrawString( m_hDisplayFont, rect, GGCOLOR_ARGB( 255, 25, 200, 25 ), TEXTPOS_CENTER|TEXTPOS_VCENTER, m_rgchGreeting );
		...
		m_pGameEngine->BDrawString( m_hDisplayFont, rect, GGCOLOR_ARGB( 255, 25, 200, 25 ), TEXTPOS_CENTER|TEXTPOS_VCENTER, m_rgchGreetingNext );
