...
public:
	...
	void SetLocalValues( const Light *pLightList, const CollisionTreeLightmapper *pColTree, int iBlur, bool bIgnoreNormals );
	void CalculateLight( const Light *pLightList, const CollisionTreeLightmapper *pColTree, int iBlur, bool bIgnoreNormals );
