...
void GetProcessorOnChipFeatures ( int iID )
{
	...
	{
		_itoa ( g_CPU.GetProcessorCacheXSize ( L1CACHE_FEATURE ), szTemp, 10 );
	...
	{
		_itoa ( g_CPU.GetProcessorCacheXSize ( L2CACHE_FEATURE ), szTemp, 10 );
	...
	{
		_itoa ( g_CPU.GetProcessorCacheXSize ( L3CACHE_FEATURE ), szTemp, 10 );
