...
class cSpecialEffect
{
	...
	public:
		...
		// reserved members
		DWORD				m_dwReserved1;								// reserved - maintain plugin compat.
		DWORD				m_dwReserved2;								// reserved - maintain plugin compat.
...
struct sObjectProperties
{
	...
	bool							bUpdateOnlyCurrentFrameBounds;				// false by default, when true it ONLY does bound for current animation frame (set object frame o,f,X)
	...
	DWORD							dwReservedOP1;								// reserved - maintain plugin compat.
