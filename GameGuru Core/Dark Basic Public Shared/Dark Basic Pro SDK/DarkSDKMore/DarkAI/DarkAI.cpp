...
void AISaveObstacleData( int iContainer, DWORD szFilename )
{
	if ( CheckAIInit ( )==0 ) return;
...
#pragma warning (disable:4312)
	pContainer->pPathFinder->SaveObstacleData( (char*) szFilename );
#pragma warning (default:4312)
}

void AILoadObstacleData( int iContainer, DWORD szFilename )
{
	if ( CheckAIInit ( )==0 ) return;
...
#pragma warning (disable:4312)
	pContainer->pPathFinder->LoadObstacleData( (char*) szFilename );
#pragma warning (default:4312)
}
...
#pragma warning ( disable : 4312 )	//convert DWORD to 'char *'
	...
	if ( !pEntity )
	{
		...
		g_pGlob->CreateDeleteString ( (DWORD*) &szReturnString, 30 );
