...
struct particle_t
{
	GGVECTOR3	m_pos;				// current position of the particle
	GGVECTOR3	m_prevPos;			// last position of the particle
	GGVECTOR3	m_velocity;			// direction and speed
	GGVECTOR3	m_acceleration;		// acceleration
...
{
	public:
		CParticleSystem ( int maxParticles, GGVECTOR3 origin );
	...
	protected:
		...
		GGVECTOR3		m_origin;								// center of the particle system

		float			m_accumulatedTime;						// used to track how long since the last particle was emitted

		GGVECTOR3		m_force;								// force ( gravity, wind, etc.) acting on the particle system
};
