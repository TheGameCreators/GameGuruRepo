...
{	
    ...
    RotateObject(m_objID,xAngle, yAngle, zAngle);
    btVector3 pos = worldTrans.getOrigin();
    PositionObject(m_objID,pos.x()*scaleFactor, pos.y()*scaleFactor, pos.z()*scaleFactor);
 }
...
{	
    ...
    RotateObject(objectID,xAngle + initialRotation.getX(), yAngle + initialRotation.getY(), zAngle + initialRotation.getZ());

    btVector3 pos = worldTrans.getOrigin();
    PositionObject(objectID,pos.x()*scaleFactor, pos.y()*scaleFactor, pos.z()*scaleFactor);
 }
