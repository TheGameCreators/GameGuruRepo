...
tagCameraData::tagCameraData ( )
{
	...
	fFOV        = GG_PI / 4;						// setup the field of view (degrees)
	...
	vecPosition = GGVECTOR3 ( 0, 0, 0 );		// position

	GGMatrixIdentity ( &matFreeFlightRotate );// freeflight
	...
	//dwBackdropColor=GGCOLOR_XRGB(0,0,128);		// color of backdrop
