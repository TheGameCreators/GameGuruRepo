...
void StereoscopicConvertLeftRightToBackFront ( int iMode, LPGGTEXTURE leftView, LPGGTEXTURE rightView, LPGGSURFACE resultingSurface0, LPGGSURFACE resultingSurface1 )
{
	...
	DWORD dwBackdropColor = GGCOLOR_XRGB(255,0,0);
...
void StereoscopicConvertLeftToGreySideBySide ( int iMode, LPGGTEXTURE pLeft, LPGGSURFACE pGrey, LPGGSURFACE pSideBySide )
{
	...
	// draw stereoscopic back/front surface from left/right textures
	DWORD dwBackdropColor = GGCOLOR_XRGB(0,0,255);
	m_pD3D->Clear ( 0, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, dwBackdropColor, 1.0f, 0 );
	m_pD3D->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, m_pStereoscopicVertex, sizeof(D3DTVERTEX_1T));
	...
	RECT rectDestRectL = { 0, 0, (LONG)(pSrcInfo.Width/2), (LONG)(pSrcInfo.Height) };
	m_pD3D->StretchRect( pLeftSurface, NULL, pSideBySide, &rectDestRectL, D3DTEXF_NONE );
	RECT rectDestRectR = { (LONG)(pSrcInfo.Width/2), 0, (LONG)(pSrcInfo.Width), (LONG)(pSrcInfo.Height) };
