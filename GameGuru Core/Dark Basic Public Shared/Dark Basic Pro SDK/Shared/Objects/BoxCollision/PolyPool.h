...
class CPolyPool
{
	...
	public:
		...
		int CheckColBox(float ax1, float ay1, float az1, float ax2, float ay2, float az2, float x1, float y1, float z1, float x2, float y2, float z2, GGVECTOR3* vResult);
		int CheckColLine(float sx, float sy, float sz, float dx, float dy, float dz, float width, float acc, GGVECTOR3* vResult);
