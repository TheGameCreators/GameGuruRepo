...
DARKSDK void MakeObjectPlane		( int iID, float fWidth, float fHeight, int iFlag, bool legacymode = false);
DARKSDK void MakeObjectTriangle		( int iID, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3 );
DARKSDK void AppendObject			( LPSTR pString, int iID, int iFrame );
...
DARKSDK void DisableObjectZWriteEx	(int iID, bool bProtectState);
...
DARKSDK void SetObjectArtFlags		( int iID, DWORD dwArtFlags, float fBoostIntensity, float fParallaxStrength  );
...
DARKSDK void SetObjectUVManually			 (int iID, int iFrameIndex, float fWidth, float fHeight);
...
DARKSDK void SetEffectToShadowMappingEx	( int iEffectID, int iDebugObjStart, int iDebugEffectIndex, int iHideDistantShadows, int iTerrainShadows, int iRealShadowResolution, int iRealShadowCascadeCount, int iC0, int iC1, int iC2, int iC3, int iC4, int iC5, int iC6, int iC7 );
...
DARKSDK int GetObjectTotalVertexCount	( int iObjectNumber );
...
// Animation
DARKSDK void SaveObjectAnimation		( int iID, LPSTR pFilename );
DARKSDK void AppendObjectAnimation		( int iID, LPSTR pFilename );
...
DARKSDK int IntersectAllEx				( int iStart, int iEnd, float fX, float fY, float fZ, float fNewX, float fNewY, float fNewZ, int iIgnoreObjNo, int iStaticOnly );
...
DARKSDK void LinkLimbEx					( int iID, int iParentID, int iLimbID, bool bDoNotReconstructMeshFrameList );
...
DARKSDK int         PickScreenObjectFromHeight  (int iX, int iY, int iObjectStart, int iObjectEnd, float starty);
...
DARKSDK SDK_FLOAT	GetFromVectorX				( void );
DARKSDK SDK_FLOAT	GetFromVectorY				( void );
DARKSDK SDK_FLOAT	GetFromVectorZ				( void );
// Emitters
