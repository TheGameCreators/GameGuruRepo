...
DARKSDK void				image_setlegacyimageloading (bool bEnable);
...
DARKSDK void				image_preload_files_finish	( void );
DARKSDK void				image_preload_files_strictwaittoend(void);
DARKSDK void				image_preload_files_wait	( void );
DARKSDK void				image_preload_files_reset	( void );
DARKSDK bool				image_preload_files_in_progress	(void);
