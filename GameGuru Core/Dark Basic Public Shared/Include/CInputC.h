...
DARKSDK char*			GetClipboard						( char* );					// get from clipboard
...
DARKSDK int  			MouseX     							( void );	// get x position
DARKSDK int  			MouseY     							( void );	// get y position
DARKSDK int  			MouseZ     							( void );	// get z position ( mouse wheel )
DARKSDK int  			MouseClick 							( void );	// get which mouse button has been clicked
DARKSDK int  			MouseMoveX 							( void );	// get the relative x movement
DARKSDK int  			MouseMoveY 							( void );	// get the relative y movement
DARKSDK int  			MouseMoveZ 							( void );	// get the relative z movement
...
DARKSDK void			SetControlDeviceEx					( char* pName, int iSubIndex );
DARKSDK void 			SetControlDevice					( char* pName );
