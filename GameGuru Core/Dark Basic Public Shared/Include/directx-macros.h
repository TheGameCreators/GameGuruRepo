...
#define LPGGEFFECT LPVOID
#define GGEFFECT_DESC LPVOID
...
#define IGGVertexBuffer LPVOID
#define IGGIndexBuffer LPVOID
#define LPGGVERTEXBUFFER LPVOID
#define LPGGINDEXBUFFER LPVOID
#define GGPRIMITIVETYPE LPVOID
#define GGFORMAT LPVOID
#define GGSURFACE_DESC LPVOID
#define GGLOCKED_RECT LPVOID
#define LPGGQUERY9 LPVOID
#define LPGGSURFACE LPVOID
#define LPGGRENDERTARGETVIEW LPVOID
#define LPGGDEPTHSTENCILVIEW LPVOID
#define LPGGSHADERRESOURCEVIEW LPVOID
#define IGGTexture LPVOID
#define IGGVertexLayout LPVOID
#define LPGGVERTEXLAYOUT LPVOID
#define IGGDevice LPVOID
...
#define GGPT_TRIANGLELIST LPVOID
#define GGPT_TRIANGLESTRIP LPVOID
#define GGBASEMATERIAL LPVOID
#define GGIMAGE_INFO LPVOID
