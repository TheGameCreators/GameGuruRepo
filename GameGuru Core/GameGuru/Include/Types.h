...
struct weaponProjectileBaseType
{
	...
	int usingRealPhysicsAdjustXAngle;
	int usingRealPhysicsAdjustYAngle;
	...
	weaponProjectileBaseType ( )
	{
		 ...
		 usingRealPhysics = 0;
		 usingRealPhysicsAdjustYAngle = 0;
		 usingRealPhysicsAdjustXAngle = 0;
...
struct gametype
{
	...
	int allowfragmentation_mainloop;
	int masterloop;
	int titleloop;
	int levelloop;
	int level;
...
struct visualstype
{
	...
	visualstype ( )
	{
		 ...
		 AmbienceBlue_f = 190.0f;
		 AmbienceGreen_f = 190.0f;
		 AmbienceRed_f = 190.0f;
...
// A structure used to store some of the data from visualstype, so that it can be restored later on.
struct visualsdatastoragetype
{
	float AmbienceRed_f;
	float AmbienceGreen_f;
	float AmbienceBlue_f;
	...
	visualsdatastoragetype()
	{
		AmbienceRed_f = 55.0f;
		AmbienceGreen_f = 55.0f;
		AmbienceBlue_f = 55.0f;
		FogR_f = 0.0f;
		FogG_f = 0.0f;
		FogB_f = 0.0f;
		FogA_f = 0.0f;
		SunIntensity_f = 7.0f;
		SunRed_f = 255.0f;//"Lighting Colour"
		SunGreen_f = 255.0f;//"Lighting Colour"
		SunBlue_f = 255.0f;//"Lighting Colour"
		ZenithRed_f = 255.0f;
	...
	visualsdatastoragetype(const visualstype& visuals)
	{
		AmbienceRed_f = visuals.AmbienceRed_f;
		AmbienceGreen_f = visuals.AmbienceGreen_f;
		AmbienceBlue_f = visuals.AmbienceBlue_f;
		FogR_f = visuals.FogR_f;
...
struct newparticletype
{
	...
	//MAX-Particles.
	bool bParticle_Preview;
	bool bParticle_Show_At_Start;
	bool bParticle_Looping_Animation;
	bool bParticle_Full_Screen;
	float fParticle_Fullscreen_Duration;
	...
	newparticletype ( )
	{
		emittername = "particlesbank/default";
		emitterid = -1;
		bParticle_Preview = true;
		bParticle_Show_At_Start = true;
		bParticle_Looping_Animation = true;
		bParticle_Full_Screen = false;
...
{
	int leftfootkeyframe;
	int rightfootkeyframe;
...
struct entityprofiletype
{
	...
	cstr hasweapon_s;
	int hasweapon;
	float handfirespotoffx;
	float handfirespotoffy;
	float handfirespotoffz;
	float handfirespotrotx;
	float handfirespotroty;
	float handfirespotrotz;
	float handfirespotsize;
	int ishealth;
	int isflak;
	int limbmax;
	int headlimb;
...
#define MAXPROPERTIESVARIABLES 80
#define MAXVARIABLESIZE 260
struct PropertiesVariables {
	...
	char VariableValue[MAXPROPERTIESVARIABLES][MAXVARIABLESIZE] = { "\0" };
	char VariableSectionDescription[MAXPROPERTIESVARIABLES][MAXVARIABLESIZE] = { "\0" };
	char VariableSectionEndDescription[MAXPROPERTIESVARIABLES][MAXVARIABLESIZE] = { "\0" };
...
struct entitytype
{
	...
	int soundset3;
	int soundset4;
	std::vector <sCharacterCreatorPlusMouthData> lipset;
	std::vector <sCharacterCreatorPlusMouthData> lipset1;
	std::vector <sCharacterCreatorPlusMouthData> lipset2;
	std::vector <sCharacterCreatorPlusMouthData> lipset3;
	std::vector <sCharacterCreatorPlusMouthData> lipset4;
...
struct gunsettingstype
{
	...
	int secondbrassactive;
	int secondbrass;
	float secondbrasslife;
	float secondbrassangle;
	float secondbrassanglerand;
	float secondbrassspeed;
	float secondbrassspeedrand;
	float secondbrassupward;
	float secondbrassupwardrand;
	float secondbrassrotx;
	float secondbrassrotxrand;
	float secondbrassroty;
	float secondbrassrotyrand;
	float secondbrassrotz;
	float secondbrassrotzrand;

	int secondbrassdelay;
	int secondzoombrassdelay;
	...
	gunsettingstype ( )
	{
		 ...
		 secondbrassactive = 0;
		 secondbrassobjmaster = 0;

		 secondbrassrotzrand = 0.0f;
		 secondbrassrotz = 0.0f;
		 secondbrassrotyrand = 0.0f;
		 secondbrassroty = 0.0f;
		 secondbrassrotxrand = 0.0f;
		 secondbrassrotx = 0.0f;
		 secondbrassupwardrand = 0.0f;
		 secondbrassupward = 0.0f;
		 secondbrassspeedrand = 0.0f;
		 secondbrassspeed = 0.0f;
		 secondbrassanglerand = 0.0f;
		 secondbrassangle = 0.0f;
		 secondbrasslife = 0.0f;
		 secondbrass = 0;
...
struct inputsystemtype
{
	...
	float localselectedplaneheight_f;
	float dragoffsetx_f;
	float dragoffsety_f;
	int kscancode;
	int keypress;
...
struct terraintype
{
	...
	float skysundirectionx_f;
	float skysundirectiony_f;
	float skysundirectionz_f;
	float sunstrength_f;
	float sunrotation_f;
	float sunrotationx_f;
	float sunrotationy_f;
	float sunrotationz_f;
	float suncolorr_f;
	float suncolorg_f;
	float suncolorb_f;
	float floorcolorr_f;
	...
	terraintype ( )
	{
		 ...
		 sunrotationz_f = 0.0f;
		 sunstrength_f = 0.0f;
		 sundirectionz_f = 0.3846f;
		 sundirectiony_f = 0.307f;
		 sundirectionx_f = 0.307f;
		 skysundirectionz_f = 0.3846f;
		 skysundirectiony_f = 0.307f;
		 skysundirectionx_f = 0.307f;
		 atz = 0;
		 atx = 0;
		 speed_f = 0.0f;
		 playerax_f = 0.0f;
...
struct charanimstatetype
{
	...
	float neckUpAndDown;
	float spineAiming;
	float spineRightAndLeft;
	float spineYAdjust;
	float spineZAdjust;
	sCharacterCreatorPlusObject ccpo;

	// Constructor
	charanimstatetype ( )
	{
		 ccpo.speak.mouthData.clear();
		 ccpo.speak.fMouthTimeStamp = 0.0f;
		 spineAiming = 0.0f;
		 spineRightAndLeft = 0;
		 spineYAdjust = 0;
		 spineZAdjust = 0;
