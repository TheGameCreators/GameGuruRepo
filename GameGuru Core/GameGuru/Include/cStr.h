...
class cStr
{
	public:
		...
		//const cStr &operator = ( const cStr& Equal );
		const cStr &operator = ( const char* szEqual );
		const cStr &operator = ( const unsigned long pDWEqual );
		cStr &operator + ( const cStr &add );
		cStr &operator + ( const unsigned long pDWAdd );
		cStr &operator += ( const cStr &add );
		cStr &operator += ( const unsigned long pDWAdd );
