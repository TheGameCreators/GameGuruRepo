...
void sliders_init ( void )
{
	...
	t.slidersmenuvalue[g.slidersmenumax][9].value=t.visuals.AmbienceGeen_f/2.55;
	...
	t.slidersmenuvalue[g.slidersmenumax][1].value=t.visuals.CameraFAR_f/700.0;
...
void sliders_write ( void )
{
	...
	if (  t.slidersmenuindex == t.slidersmenunames.visuals ) 
	{
		...
		t.visuals.AmbienceGeen_f=t.slidersmenuvalue[t.slidersmenuindex][9].value*2.55;
	...
	if (  t.slidersmenuindex == t.slidersmenunames.camera ) 
	{
		...
		t.visuals.CameraFAR_f=t.slidersmenuvalue[t.slidersmenuindex][1].value*700.0;
...
//  `endif
	if (  t.slidersmenuindex == t.slidersmenunames.qualitypanel ) 
	{
		...
		if (  t.visuals.VegQuantity_f != t.slidersmenuvalue[t.slidersmenuindex][5].value  )  t.visuals.refreshvegetation = 1;
		if (  t.visuals.VegWidth_f != t.slidersmenuvalue[t.slidersmenuindex][6].value  )  t.visuals.refreshvegetation = 1;
		if (  t.visuals.VegHeight_f != t.slidersmenuvalue[t.slidersmenuindex][7].value  )  t.visuals.refreshvegetation = 1;
