	...
	if ( t.game.levelendingcycle == 0 )
	{
		if ( (t.game.gameisexe == 0 || g.gprofileinstandalone == 1) && t.game.runasmultiplayer == 0 ) 
		{
			...
			if (  g.globals.ideinputmode == 1 ) 
			{
				...
				if (KeyState(g.keymap[59]) == 1 && (KeyState(g.keymap[42]) == 1 || KeyState(g.keymap[54]) == 1))  g.lmlightmapnowmode = 1;
				if (KeyState(g.keymap[60]) == 1 && (KeyState(g.keymap[42]) == 1 || KeyState(g.keymap[54]) == 1))  g.lmlightmapnowmode = 2;
				if (KeyState(g.keymap[61]) == 1 && (KeyState(g.keymap[42]) == 1 || KeyState(g.keymap[54]) == 1))  g.lmlightmapnowmode = 3;
				if (KeyState(g.keymap[62]) == 1 && (KeyState(g.keymap[42]) == 1 || KeyState(g.keymap[54]) == 1))  g.lmlightmapnowmode = 4;
