		...
		for ( t.l = 0 ; t.l<=  399; t.l++ )
		{
			...
			if (  Len(t.line_s.Get())>0 ) 
			{
				if (  t.line_s.Get()[0] != ';' ) 
				{
					...
					//  entity AI
					//t.tryfield_s="aiinit"; //PE: Not used anymore.
					...
					//t.tryfield_s="aishoot"; //PE: Not used anymore.
					//if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].aishoot_s = Lower(t.value_s.Get());

					#ifdef VRTECH
					t.tryfield_s="voice";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].voiceset_s = t.value_s;
					t.tryfield_s="speakrate";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].voicerate = t.value1;
					#endif
					...
					*/
					...
					#ifdef VRTECH
					#else
					t.tryfield_s="handfirespotoffx";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotoffx = t.value1;
					t.tryfield_s="handfirespotoffy";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotoffy = t.value1;
					t.tryfield_s="handfirespotoffz";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotoffz = t.value1;
					t.tryfield_s="handfirespotrotx";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotrotx = t.value1;
					t.tryfield_s="handfirespotroty";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotroty = t.value1;
					t.tryfield_s="handfirespotrotz";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotrotz = t.value1;
					t.tryfield_s="handfirespotsize";
					if (  t.field_s == t.tryfield_s  )  t.entityprofile[t.entid].handfirespotsize = t.value1;
					#endif
					...
					if (  t.entityprofile[t.entid].footfallmax>0 ) 
					{
						for ( t.q = 0 ; t.q <= t.entityprofile[t.entid].footfallmax-1; t.q++ )
						{
							...
							if (  t.field_s == t.tryfield_s ) { t.entityfootfall[t.entid][t.q].leftfootkeyframe = t.value1  ; t.entityfootfall[t.entid][t.q].rightfootkeyframe = t.value2; }
						}
					}
				...
				if ( t.entityprofile[t.entid].ischaracter != 0 )
				{
					for (int s = 0; s < 4; s++)
					{
						...
						if (bFoundSound == true)
						{
							...
							char pWAVFile[2048];
							char pLIPFile[2048];
							if (s == 0) strcpy(pLIPFile, t.entityelement[t.e].eleprof.soundset_s.Get());
							if (s == 1) strcpy(pLIPFile, t.entityelement[t.e].eleprof.soundset1_s.Get());
							if (s == 2) strcpy(pLIPFile, t.entityelement[t.e].eleprof.soundset2_s.Get());
							if (s == 3) strcpy(pLIPFile, t.entityelement[t.e].eleprof.soundset3_s.Get());
			...
			if (  g.entityelementlist>0 ) 
			{
				...
				for ( t.e = 1 ; t.e<=  g.entityelementlist; t.e++ )
				{
					...
					if (  t.versionnumberload >= 102 ) 
					{
						...
						#ifdef PRODUCTCLASSIC
						t.a = c_ReadLong(1); t.entityelement[t.e].eleprof.spare1 = t.a;
						t.a = c_ReadLong(1); t.entityelement[t.e].eleprof.spare1 = t.a;
						t.a = c_ReadLong(1); t.entityelement[t.e].eleprof.spare1 = t.a;
						t.a = c_ReadLong(1); t.entityelement[t.e].eleprof.spare1 = t.a;
						t.a = c_ReadLong(1); t.entityelement[t.e].eleprof.spare1 = t.a;
	...
	if ( g.entityelementlist>0 ) 
	{
		for ( t.e = 1 ; t.e<=  g.entityelementlist; t.e++ )
		{
			if ( t.versionnumbersave >= 101 ) 
			{
				...
				//t.a_s=t.entityelement[t.e].eleprof.aiinit_s ; //PE: Not used anymore.
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
				t.a_s=t.entityelement[t.e].eleprof.aimain_s ; WriteString (  1,t.a_s.Get() );
				// t.a_s=t.entityelement[t.e].eleprof.aidestroy_s ; //PE: Not used anymore.
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
				...
				//t.a_s=t.entityelement[t.e].eleprof.ifusednear_s ;
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
				...
				// t.a_s=t.entityelement[t.e].eleprof.aishoot_s ; //  //PE: Not used anymore.
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
				...
				//t.a_s=t.entityelement[t.e].eleprof.basedecal_s ;  //PE: Not used anymore.
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
			}
			...
			if (  t.versionnumbersave >= 103 ) 
			{
				...
				//t.a=t.entityelement[t.e].eleprof.phydw4 ;
				t.a = 0; WriteLong(1, t.a);
				//t.a=t.entityelement[t.e].eleprof.phydw5 ;
				t.a = 0; WriteLong (  1,t.a );
			}
			...
			{
				//  Reloaded ALPHA 1.0045
				//t.a_s=t.entityelement[t.e].eleprof.aiinitname_s ; //PE: Not used anymore.
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
				t.a_s=t.entityelement[t.e].eleprof.aimainname_s ; WriteString (  1,t.a_s.Get() );
				//t.a_s=t.entityelement[t.e].eleprof.aidestroyname_s ;
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
				//t.a_s=t.entityelement[t.e].eleprof.aishootname_s ;
				t.a_s = "";
				WriteString (  1,t.a_s.Get() );
			}
			...
			{
				// VRQ V3
				t.a_s=t.entityelement[t.e].eleprof.voiceset_s ; WriteString ( 1,t.a_s.Get() );
				t.a = t.entityelement[t.e].eleprof.voicerate; WriteLong ( 1, t.a );
			}
			#endif
		}
	}
