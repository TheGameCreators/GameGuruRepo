...
function play_video_on_entity4_init(e)
	...
	video_trigger_range[e] = 200
	prompt_to_start_video[e] = "Press E key to Start Video 4"
	prompt_to_stop_video[e] = "Press ALT key to Stop Video 4"
	---------------------------------------------------------------------------------------

play_once[e] = 0
end

function play_video_on_entity4_main(e)
