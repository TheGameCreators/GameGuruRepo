...
-- This special door script allows for you to add the name of the level to jump to in the 
-- IFUsed properties of this entity. Once the door is opened, the player will advance to 
-- the specified map/level.

door_pressed = 0

function windoor_init(e)
end
	 
function windoor_main(e)
