...
function ai_fantasycharacter_barbarian_init(e)
 ai_soldier_state[e] = "patrol"
 ai_soldier_pathindex[e] = -1
 SetAnimationFrames(26010,26283) 
 LoopAnimation(e)
 ModulateSpeed(e,1.0)
 ...
 attackend[e]=26989
 attacktype[e]=0
 damageframestart[e]=26963
 damageframeend[e]=26967
 lastroar[e] = 0
 lastswipe[e] = 0
 ai_old_health[e] = -1
...
function ai_fantasycharacter_barbarian_main(e)
  ...
  if GetPlayerDistance(e)<attackdistance[e] and g_PlayerHealth>0 then
   if ai_soldier_state[e] ~= "attack" then
	...
	if attacktype[e]==2 then
     attackstart[e]=27000
     attackend[e]=27046
     damageframestart[e]=27024
     damageframeend[e]=27030
	end
...
function ai_fantasycharacter_barbarian_exit(e)
