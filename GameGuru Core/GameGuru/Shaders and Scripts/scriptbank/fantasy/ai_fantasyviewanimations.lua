...
ai_viewanimations_frm = 26000
ai_viewanimations_pressed = 0

function ai_fantasyviewanimations_init(e)
 CharacterControlLimbo(e)
 SetAnimationFrames(e,0,10000)
 LoopAnimation(e)
end

function ai_fantasyviewanimations_main(e)
 RotateToPlayer(e)
 CharacterControlLimbo(e)
 ...
 Prompt ( "ai_fantasyviewanimations_frm = " .. ai_viewanimations_frm )
end