...
function ai_fantasycharacter_ranger_init(e)
 ai_soldier_state[e] = "patrol"
 ai_soldier_pathindex[e] = -1
 SetAnimationFrames(22010,22090) 
 LoopAnimation(e)
 ModulateSpeed(e,1.0)
 ...
 attackend[e]=22834
 attacktype[e]=0
 damageframestart[e]=22814
 damageframeend[e]=22819
 lastroar[e] = 0
 lastswipe[e] = 0
 ai_old_health[e] = -1
...
function ai_fantasycharacter_ranger_main(e)
 ...
 --Prompt( "Ranger anim = " .. GetAnimationFrame(e) )
end

function ai_fantasycharacter_ranger_exit(e)
