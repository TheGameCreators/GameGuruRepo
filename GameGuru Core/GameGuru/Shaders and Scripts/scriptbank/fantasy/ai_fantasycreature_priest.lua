...
function ai_fantasycreature_priest_init(e)
 ai_soldier_state[e] = "patrol"
 ai_soldier_pathindex[e] = -1
 SetAnimationFrames(10,70) 
 LoopAnimation(e)
 ModulateSpeed(e,1.0)
...
function ai_fantasycreature_priest_main(e)
...
function ai_fantasycharacter_priest_exit(e)
