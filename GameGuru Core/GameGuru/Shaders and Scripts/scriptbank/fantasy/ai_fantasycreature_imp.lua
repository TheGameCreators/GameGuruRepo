...
function ai_fantasycreature_imp_init(e)
 ai_soldier_state[e] = "patrol"
 ai_soldier_pathindex[e] = -1
 SetAnimationFrames(10,100) 
 LoopAnimation(e)
 ModulateSpeed(e,1.0)
 SetAnimationSpeed(e,1.0)
 attackstart[e]=980
 attackend[e]=1022
 damageframestart[e]=1000
 damageframeend[e]=1012
 lastroar[e] = 0
 lastswipe[e] = 0
 attacktype[e] = 0
 ai_old_health[e] = -1
...
function ai_fantasycreature_imp_main(e)
...
function ai_fantasycreature_imp_exit(e)
