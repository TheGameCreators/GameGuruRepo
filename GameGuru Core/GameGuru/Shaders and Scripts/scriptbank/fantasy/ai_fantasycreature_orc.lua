...
function ai_fantasycreature_orc_init(e)
 ai_soldier_state[e] = "patrol"
 ai_soldier_pathindex[e] = -1
 SetAnimationFrames(10,115) 
 LoopAnimation(e)
 ModulateSpeed(e,1.0)
 SetAnimationSpeed(e,1.0)
 attackstart[e]=795
 attackend[e]=845
 damageframestart[e]=820
 damageframeend[e]=835
 lastroar[e] = 0
 lastswipe[e] = 0
 attacktype[e] = 0
 ai_old_health[e] = -1
...
function ai_fantasycreature_orc_main(e)
 ...
 if PlayerDist < viewrange[e] then
  if GetPlayerDistance(e)<80 and g_PlayerHealth>0 then
...
function ai_fantasycreature_orc_exit(e)
