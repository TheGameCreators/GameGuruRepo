...
function ai_fantasyally_knight_init(e)
...
function ai_fantasyally_knight_enemydist(ee,e)
...
function ai_fantasyally_knight_main(e)
 lidlestart=24010
 lidleend=24283
 lfidgetstart=24290
 lfidgetend=24391
 ...
 lattackstart=24880
 lattackend=24919
 ldamageframestart=24900
 ldamageframeend=24910
 ...
 if ai_soldier_state[e] == "attackenemy" then
  ...
  ddd = ai_fantasyally_knight_enemydist(ee,e)
  if ddd < 90 then
   AIEntityGoToPosition(AIObjNo,g_Entity[e]['x'],g_Entity[e]['y'],g_Entity[e]['z']) 
...
function ai_fantasyally_knight_exit(e)
 PlaySound(e,3)
 CollisionOff(e)
end
