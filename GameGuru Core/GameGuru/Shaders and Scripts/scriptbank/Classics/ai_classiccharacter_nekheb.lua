...
-- NEKHEB Animframes:
-- 2499,2523 - walk
-- 2527,2557 - attack (2543)
-- 2564,2582 - run
-- 2584,2614 - attack (2601)
-- 2618,2699 - roar
-- 2700,2745 - hurt
-- 2746,2784 - strafe
-- 2618,2618 - idle
...
function ai_classiccharacter_nekheb_init(e)
 ...
 attackstart[e]=2527
 attackend[e]=2557
 damageframestart[e]=2543
 damageframeend[e]=2547
 lastroar[e] = 0
 lastswipe[e] = 0
 ai_old_health[e] = -1
...
function ai_classiccharacter_nekheb_main(e)
...
function ai_classiccharacter_nekheb_exit(e)
