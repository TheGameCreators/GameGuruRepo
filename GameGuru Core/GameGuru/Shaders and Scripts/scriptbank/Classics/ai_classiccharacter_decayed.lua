...
-- 2580,2610 - WALK
-- 2630,2670 - RUN
-- 2691,2763 - DOUBLESWIPE (2712) (2729)
-- 2781,2824 - SINGLESWIPE (2804)
-- 2840,2910 - GETUP FRONT
-- 2894,2904 - HURT
-- 2931,2979 - RAGE (ROAR)
...
function ai_classiccharacter_decayed_init(e)
 ...
 attackstart[e]=2781
 attackend[e]=2824
 damageframestart[e]=2804
 damageframeend[e]=2808
 lastroar[e] = 0
 lastswipe[e] = 0
 ai_old_health[e] = -1
...
function ai_classiccharacter_decayed_main(e)
  ...
  if GetPlayerDistance(e)<attackdistance[e] and g_PlayerHealth>0 then
   if ai_soldier_state[e] ~= "attack" then
	...
	if attacktype[e] == 2 then
     attackstart[e]=2691
     attackend[e]=2763
     damageframestart[e]=2712
     damageframeend[e]=2716
	end
	if attacktype[e] == 3 then
     attackstart[e]=2691
     attackend[e]=2763
     damageframestart[e]=2729
     damageframeend[e]=2732
	end
...
function ai_classiccharacter_decayed_dying(e)
 CollisionOff(e)
...
function ai_classiccharacter_decayed_preexit(e)
 SetPreExitValue(e,1)
 ...
 if dyingstart[e] > 0 and dyingend[e] > 0 then
  if ai_bot_state[e] ~= ai_state_preexit then
   ...
   ai_classiccharacter_decayed_dying(e)
  end
 else 
  SetPreExitValue(e,2)
 end
...
function ai_classiccharacter_decayed_exit(e)
 CollisionOff(e)
 PlayCharacterSound(e,"onDeath")
end