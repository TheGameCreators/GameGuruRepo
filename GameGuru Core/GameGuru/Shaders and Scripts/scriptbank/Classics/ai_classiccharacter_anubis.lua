...
function ai_classiccharacter_anubis_init(e)
 CharacterControlLimbo(e)
 ai_soldier_state[e] = "patrol"
 ai_soldier_pathindex[e] = -1
 SetAnimationFrames(2720,2742) 
 LoopAnimation(e)
 ModulateSpeed(e,1.0)
...
function ai_classiccharacter_anubis_main(e)
...
function ai_classiccharacter_anubis_exit(e)
