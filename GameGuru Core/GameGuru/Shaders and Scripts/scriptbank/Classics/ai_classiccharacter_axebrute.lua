...
-- AXEBRUTE Animframes:
-- 2500,2524 - walk
-- 2527,2553 - attack (2541)
-- 2562,2581 - run
-- 2584,2609 - attack (2598)
-- 2613,2653 - roar
-- 2659,2740 - hurt
-- 210,232   - idle
...
function ai_classiccharacter_axebrute_init(e)
...
function ai_classiccharacter_axebrute_main(e)
  ...
  if GetPlayerDistance(e)<attackdistance[e] and g_PlayerHealth>0 then
   if ai_soldier_state[e] ~= "attack" then
	...
	if attacktype[e] == 2 then
     attackstart[e]=2584
     attackend[e]=2609
     damageframestart[e]=2598
     damageframeend[e]=2602
	end
...
function ai_classiccharacter_axebrute_exit(e)
