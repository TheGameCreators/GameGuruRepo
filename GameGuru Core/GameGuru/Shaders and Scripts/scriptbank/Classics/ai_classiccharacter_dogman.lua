...
function ai_classiccharacter_dogman_init(e)
 ...
 attackstart[e]=102
 attackend[e]=164
 damageframestart[e]=142
 damageframeend[e]=147
 lastroar[e] = 0
 lastswipe[e] = 0
 ai_old_health[e] = -1
...
function ai_classiccharacter_dogman_main(e)
  ...
  if GetPlayerDistance(e)<attackdistance[e] and g_PlayerHealth>0 then
   if ai_soldier_state[e] ~= "attack" then
	...
	if attacktype[e] == 2 then
     attackstart[e]=166
     attackend[e]=203
     damageframestart[e]=189
     damageframeend[e]=194
	end
...
function ai_classiccharacter_dogman_exit(e)
