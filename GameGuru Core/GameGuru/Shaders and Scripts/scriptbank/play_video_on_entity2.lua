...
function play_video_on_entity2_init(e)
	...
	prompt_to_start_video[e] = "Press E key to Start Video 2"
	prompt_to_stop_video[e] = "Press ALT key to Stop Video 2"
	---------------------------------------------------------------------------------------

play_once[e] = 0
end

function play_video_on_entity2_main(e)
