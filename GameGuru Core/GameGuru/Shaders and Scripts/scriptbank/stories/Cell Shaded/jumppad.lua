...
local use_key = "e"
local use_pad_range = 120
local travel_speed = 900
local climb_speed = 400
...
function jumppad_init_name(e,name)
weapon_name[e] = name
state[e] = "wait"
...
if GetPlayerFlatDistance(target[e]) > start_distance / 2 then
MoveUp(missile[e],climb_speed)
MoveForward(missile[e],travel_speed)
TransportToIfUsed(e)
elseif GetPlayerFlatDistance(target[e]) > 50 then
MoveUp(missile[e],-climb_speed)
MoveForward(missile[e],travel_speed)
TransportToIfUsed(e)
else
