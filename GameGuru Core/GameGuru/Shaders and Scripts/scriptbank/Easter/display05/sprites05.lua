...
function sprites05_init(e)
 ...
 MyImage5 = LoadImage("scriptbank\\images\\Easter\\004.png")
 MySprite5 = CreateSprite (MyImage5)
 SetSpriteDepth (MySprite5, 100)
 SetSpriteSize (MySprite5 , -1 , -1 )	
 SetSpritePosition(MySprite5,95,35)
end

function sprites05_main(e)
 if EggsCollected == 1 then
  DeleteSprite(MySprite1)
  DeleteSprite(MySprite2)
  DeleteSprite(MySprite3)
  DeleteSprite(MySprite4)
  DeleteSprite(MySprite5)
 end
