...
bool btAxisSweep3Internal<BP_FP_INT_TYPE>::testOverlap2D(const Handle* pHandleA, const Handle* pHandleB,int axis0,int axis1)
{
	...
	/* not needed now found it was uninitialised quaternoin rotation thart caused it!
	if ( ((Edge*)(m_pEdges[axis0]+pHandleA->m_maxEdges[axis0]))->m_pos < ((Edge*)(m_pEdges[axis0]+pHandleB->m_minEdges[axis0]))->m_pos ||
		 ((Edge*)(m_pEdges[axis0]+pHandleB->m_maxEdges[axis0]))->m_pos < ((Edge*)(m_pEdges[axis0]+pHandleA->m_minEdges[axis0]))->m_pos ||
		 ((Edge*)(m_pEdges[axis1]+pHandleA->m_maxEdges[axis1]))->m_pos < ((Edge*)(m_pEdges[axis1]+pHandleB->m_minEdges[axis1]))->m_pos ||
		 ((Edge*)(m_pEdges[axis1]+pHandleB->m_maxEdges[axis1]))->m_pos < ((Edge*)(m_pEdges[axis1]+pHandleA->m_minEdges[axis1]))->m_pos)
	{
		return false; 
	}
	*/
