...
#include ".\..\Dark Basic Public Shared\Dark Basic Pro SDK\Shared\Sound\csoundmanagerc.h"
#include ".\..\Dark Basic Public Shared\Dark Basic Pro SDK\Shared\Sound\csounddatac.h"
