...
#include ".\..\Dark Basic Public Shared\Dark Basic Pro SDK\Shared\SpecialEffects\cpositionc.h"
#include ".\..\Dark Basic Public Shared\Dark Basic Pro SDK\Shared\SpecialEffects\cparticlemanagerc.h"
#include <math.h>
