...
#include ".\..\Dark Basic Public Shared\Dark Basic Pro SDK\Shared\Vectors\cVectorManagerC.h"
#include ".\..\Dark Basic Public Shared\Dark Basic Pro SDK\Shared\Vectors\cVectorDataC.h"
