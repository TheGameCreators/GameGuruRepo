...
public:
	afx_msg void OnStnClickedStaticVersion18();
	afx_msg void OnStnClickedStaticCredits14();
	afx_msg void OnStnClickedStaticVersion24();
	afx_msg void OnStnClickedStaticCredits11();
	afx_msg void OnStnClickedStaticVersion15();
};
