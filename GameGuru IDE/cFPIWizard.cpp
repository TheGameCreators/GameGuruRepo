...
void cFPIWizard::DoDataExchange(CDataExchange* pDX)
{
	...
	if ( g_bX9InterfaceMode==true ) DDX_Control ( pDX, IDCPREVIEW, m_Buttons [ 0 ] );
...
void cFPIWizard::OnSize(UINT nType, int cx, int cy) 
{
	...
	// FPGC - 181209 - reduced size of property gadget so can add NOTE about outside FPI editing
	m_PropertyWindow.SetWindowPos (NULL, -1, -1, cx, 280, SWP_NOMOVE | SWP_NOACTIVATE | SWP_NOZORDER);
}
