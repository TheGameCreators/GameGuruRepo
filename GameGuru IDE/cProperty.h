...
public:
	...
	void CheckForNewControls2	( void );	//new method for checking grouped controls in a single pass
...
protected:
	...
	HANDLE m_hEntityDataFile;
	DWORD* m_pRawDataPtr;
	DWORD* m_pEntityDataPtr;

	int NewGroup( int iFilePos );
	char* GetFileMapString( int* pPos );
};
