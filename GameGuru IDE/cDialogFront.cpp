...
BOOL cDialogFront::OnInitDialog() 
{
   ...
   */
	...
	char szDebug [ 256 ] = "";
	GetPrivateProfileString ( _T ( "Demo" ), _T ( "Text" ), _T ( "" ), szDebug, MAX_PATH, theApp.m_szLanguageVariant );
	...
	CoreReadStringFromRegistry ( "SOFTWARE\\The Game Creators\\GameGuruInfo", "demodatepleasedonothackV1", szData, &dwValue );
...
void cDialogFront::OnOK() 
{
	...
	if ( !m_bValid )
	{
		...
		{
			char szDebug [ 256 ] = "";
			GetPrivateProfileString ( _T ( "Demo" ), _T ( "Order" ), _T ( "" ), szDebug, MAX_PATH, theApp.m_szLanguageVariant );
			::ShellExecute (NULL, NULL, szDebug, NULL, NULL, NULL);
