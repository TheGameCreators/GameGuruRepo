...
void cBuildGameBuild::SetControl ( cControls* pControl )
{
	...
	m_pControls->AddRadioButton ( &m_DynamicLighting,     15 );
...
void cBuildGameBuild::DoDataExchange ( CDataExchange* pDX )
{
	...
	DDX_Control ( pDX, IDC_CHECK_DYNAMIC_LIGHTS,		m_DynamicLighting );
	...
	// X10 - 271107 - added missing translatable
	...
	// X10 - 271107 - reuse preferences group name as it is identical
	m_Lines [ 5 ].SetWindowText ( GetLanguageData ( "Preferences", "Box2" ) );
	...
	m_DynamicLighting.SetWindowText		( GetLanguageData ( "Build Game Build", "Item6" ) );
...
//	{
//		m_DynamicShadows.ShowWindow ( SW_HIDE );
///		m_DynamicLighting.ShowWindow ( SW_HIDE );
//		m_NoEffects.ShowWindow ( SW_HIDE );
//		m_EssentialEffects.ShowWindow ( SW_HIDE );
//		m_FullEffects.ShowWindow ( SW_HIDE );
//		m_NoFloor.ShowWindow ( SW_HIDE );
//		m_Lines [ 3 ].ShowWindow ( SW_HIDE );
...
BEGIN_MESSAGE_MAP ( cBuildGameBuild, CDialog )
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_STATIC_6, &cBuildGameBuild::OnBnClickedStatic6)
	ON_BN_CLICKED(IDC_STATIC_5, &cBuildGameBuild::OnBnClickedStatic5)
END_MESSAGE_MAP()
...
void cBuildGameBuild::DisableAll ( void )
{
	...
	m_DynamicLighting.EnableWindow ( FALSE );
...
void cBuildGameBuild::EnableAll ( void )
{
	...
	m_DynamicLighting.EnableWindow ( TRUE );
...
void cBuildGameBuild::OnBnClickedStatic6()
{
	// TODO: Add your control notification handler code here
}

void cBuildGameBuild::OnBnClickedStatic5()
{
	// TODO: Add your control notification handler code here
}
