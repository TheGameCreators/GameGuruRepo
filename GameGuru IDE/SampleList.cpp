...
void CSampleList::LoadSampleFiles( )
{
	...
	// 101013 - moved location of samples folder
	...
	//SetCurrentDirectory ( pMyDocumentsFolderFile );
	SetCurrentDirectory( theApp.m_szDirectory );
	SetCurrentDirectory( _T("files") );
	SetCurrentDirectory( _T("mapbank") );
	SetCurrentDirectory( _T("samples") );
	// NOTE: Eventually and soon, move writables to MyDocs folder!!
